...
class Test {
	...
	static function main(){
			...
			var r_bio_write = BIO_write(bio, neko.Lib.haxeToNeko(wbuf), 6);
			trace ("BIO_write["+wbuf+"] = "+r_bio_write+"\n");
			var rlen : Int = 254;
			var rbuf: String = BIO_read (bio, rlen);
